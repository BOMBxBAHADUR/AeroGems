...
<html lang="en">
  ...
  <sql:setDataSource var="dbConnection" driver="com.mysql.jdbc.Driver"
    ...
    <div class="main">
      <div class="form">
          ...
          <a href="${pageContext.request.contextPath}/pages/admin/product.jsp">
              <button class="edit-button" style="margin-left:27%;" type="submit" name="login">
    ...
    <footer class="final">
      <div class="footer">
        ...
        <div class="footer-right">
          <center style="padding-top: 5%">
            <img src="${pageContext.request.contextPath}/images/logo.png" alt="" srcset="" width="70%" />
          </center>
          <br />
      ...
      <div class="copyright">
        <br />
        &copy2024 AeroGems. All Rights Reserved.
        <br />
      </div>
    </footer>
    <script>
